 ...
 */
static void
SHA256_Transform(uint32_t state[static __restrict 8],
    const uint8_t block[static __restrict 64],
    uint32_t W[static __restrict 64], uint32_t S[static __restrict 8])
{
	int i;
...
static void
SHA256_Pad(SHA256_CTX * ctx, uint32_t tmp32[static __restrict 72])
{
	size_t r;
...
_SHA256_Update(SHA256_CTX * ctx, const void * in, size_t len,
    uint32_t tmp32[static __restrict 72])
{
	uint32_t r;
...
_HMAC_SHA256_Init(HMAC_SHA256_CTX * ctx, const void * _K, size_t Klen,
    uint32_t tmp32[static __restrict 72], uint8_t pad[static __restrict 64],
    uint8_t khash[static __restrict 32])
{
	const uint8_t * K = _K;
	size_t i;
...
_HMAC_SHA256_Final(uint8_t digest[32], HMAC_SHA256_CTX * ctx,
    uint32_t tmp32[static __restrict 72], uint8_t ihash[static __restrict 32])
{
